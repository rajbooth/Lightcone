...
### Data structure
The lightcone file comprises 22 datasets, one for each of the 42 GADGET snapshots that were used in its construction, ranging 

## Visualisation
![enter image description here](https://raw.githubusercontent.com/rajbooth/Lightcone/master/images/Halo_lightcone.png)

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkyODY1MzIzMl19
-->