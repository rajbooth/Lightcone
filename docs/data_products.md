...
```
### Co-ordinate system
Positional data is stored in celestial co-ordinates, i.e. radial co-moving distance to observer $r$, declination from equatorial plane $Dec$ , and right ascension $RA$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgzNDY5NTcyMywtMTg1NjY3NjAzLC0xOD
