...
We use this to calculate the cumulative probability for a range of luminosity values, form whjich we cons
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQyOTk4NDc0LDE3NDk2NTYzNDAsLTE4Mj
