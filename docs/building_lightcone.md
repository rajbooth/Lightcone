...
### Luminosity data
In addition to the particle positions, the lighcone contains information about the luminosity of each galaxy.  This data is generated by assigning each particle with a relative luminosity value $L/L^*$ such that the resultant luminosity distribution follows a Schechter function.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzEyNTQwMzk2LDY4NDkxMzg3MiwtNzIwMz
